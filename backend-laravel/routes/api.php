...
Route::get('/test-token', [AuthController::class, 'testToken'])->name('api.test-token'); // TEMPORAIRE
...
Route::middleware('auth:sanctum')->name('api.')->group(function () {
    ...
    Route::get('/notifications/user/{user_id}', [NotificationController::class, 'getUserNotifications'])->name('notifications.user.all');
    Route::get('/notifications/user/{user_id}/unread', [NotificationController::class, 'getUnread'])->name('notifications.user.unread');
    Route::get('/notifications/user/{user_id}/stats', [NotificationController::class, 'getStats'])->name('notifications.user.stats');
    Route::put('/notifications/{id}/read', [NotificationController::class, 'markAsRead'])->name('notifications.mark_read');
    Route::put('/notifications/user/{user_id}/read-all', [NotificationController::class, 'markAllAsRead'])->name('notifications.read_all');
