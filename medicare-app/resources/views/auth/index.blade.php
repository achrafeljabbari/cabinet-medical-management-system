        ...
        <div class="main" id="main">
            ...
            <div class="switch" id="switch-cnt">
                ...
                <div class="switch__container" id="switch-c1">
                    ...
                    <button type="button" class="switch__button button switch-btn">SE CONNECTER</button>
                </div>
                ...
                <div class="switch__container is-hidden" id="switch-c2">
                    ...
                    <button type="button" class="switch__button button switch-btn">S'INSCRIRE</button>
                </div>
            </div>
        </div>
    </div>
...
document.getElementById('register-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        messagesDiv.innerHTML = '<div class="success-box">✓ Inscription réussie! Redirection vers la connexion...</div>';
...
document.getElementById('login-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        messagesDiv.innerHTML = '<div class="success-box">✓ Connexion réussie! Redirection vers votre tableau de bord...</div>';
